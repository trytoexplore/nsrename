...
class TEXT:
    ...
    UPLOAD_SUCESS = f"Thanks for using [me](https://github.com/LG-Bot-Updates)"
...
** Channel:** [LG Bot Updates](https://t.me/LG_Bot_Updates)

** Group:** [LG Bots Support](https://t.me/horrorserialsg)
